...
@section('body')
    <div class="container">
        <div class="d-flex justify-content-center row" style="color: black;">
            <div class="col-md-12">
                <div class="mb-4">
                    <h4>
                        <i class="fas fa-shopping-bag"></i>&nbsp; Why Choose Me &nbsp;
                ...
                <?php
                $chooses = DB::table('user_metas')->where('user_key', 'choose_info')->where("user_id", session('user_id'))->pluck('user_value')->first();
                if($chooses):
                    $chooses = json_decode($chooses, true);
    ...
    <div class="container mt-4" id="info_form" style="display: none;">
        ...
        <form action="{{ route('choose-info-db') }}" method="post" enctype="multipart/form-data">
            @csrf
